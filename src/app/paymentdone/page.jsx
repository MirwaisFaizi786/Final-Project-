    ...
    <div className="pt-24">
      <div class=" h-screen">
        <div class=" p-6  md:mx-auto">
          ...
          <div class="text-center flex flex-col justify-center w-1/2 mx-auto">
            <h3 class="md:text-2xl text-base text-gray-900 font-semibold ">
            ...
            <div class="py-10 text-center">
              <div>
                <Link href="/profile">
                  <button class="block  max-w-xs mx-auto bg-orange-400 hover:bg-orange-500 focus:bg-orange-600 text-white rounded-lg px-3 py-2 font-semibold">
                    <i class="mdi mdi-lock-outline mr-1"></i> GO TO MY PROFILE
                  </button>
                </Link>
              </div>
            </div>
